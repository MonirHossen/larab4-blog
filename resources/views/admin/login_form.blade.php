    ...
    <div class="container-fluid page-body-wrapper full-page-wrapper">
        <div class="content-wrapper d-flex align-items-stretch auth auth-img-bg">
            <div class="row flex-grow">
                        ...
                        <form class="pt-3" action="{{route('login')}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" value="{{old('email')}}" class="form-control form-control-lg border-left-0" id="email" placeholder="Email">
                                </div>
                            </div>
                            <div class="form-group">
                ...
                <div class="col-lg-6 login-half-bg d-flex flex-row" style="background-image: url('{{asset('images/admin/login-bg.jpg')}}')">
